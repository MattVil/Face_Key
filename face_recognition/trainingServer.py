...
model.add(Convolution2D(64, 3, 3, border_mode="same", input_shape=input_shape, name='conv1_1'))
...
# save the model
model.save('large/new_model.h5')
print("model saved in new_model.h5 !\n")


filename='large/model_train_new.csv'
csv_log=callbacks.CSVLogger(filename, separator=',', append=False)

early_stopping=callbacks.EarlyStopping(monitor='val_loss', min_delta=0, patience=0, verbose=0, mode='min')

filepath="large/Best-weights-my_model-{epoch:03d}-{loss:.4f}-{acc:.4f}.hdf5"
