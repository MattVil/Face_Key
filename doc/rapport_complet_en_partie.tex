...
Les deux individus ont une forme de visage assez ronde, des yeux qui se ressemblent, des cheveux longs ? Les erreurs commise entre ces deux classes sont donc compréhensible (ce nombre d'erreur reste très faible par rapport au nombre d'images total)
