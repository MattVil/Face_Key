...
Nous n'avons pas encore défini exactement comment se fera l'intégration du projet de système d'exploitation dans Face Key.
...
Le principe de la convolution est d'utiliser des noyaux, initialisés aléatoirement puis appris, que l'on va convoluer sur l'image d'entrée pour obtenir des filtres. Dans un filtre obtenu, chaque valeur sera le taux de correspondance entre le noyau et la partie de l'image centré en ce point.
